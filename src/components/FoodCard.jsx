...
const FoodCard = ({name,id,desc,price, rating, img, handleToast }) => {
    ...
    return (
        <div className=' sm:w-[250px] w-[150px] p-0    sm:p-8 shadow-2xl shadow-black rounded-lg  mt-10 '>
            ...
            <div className=' flex justify-between'>
                ...
                <button onClick={() => {
                    dispatch(addToCart({id, name, price, rating, img, handleToast, qty: 1}));
                    handleToast(name);
